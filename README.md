...
Kinmu-OSは、従業員100名以下の組織を対象にしたセルフホスト型の労務・勤怠管理ソフトです。v0.6は従業員台帳、勤務カレンダー、出退勤・休憩打刻、勤怠修正、休暇管理、残業・休日出勤申請、月次締めに加え、公開版プロファイルと全件検査を備えた給与連携CSV、追記型run、再現性確認、監査ログを扱います。
...
リポジトリでは [利用ガイドの目次](docs/user-guide/overview.md) から役割別の手順を確認できます。稼働中のアプリでは、ログイン後に「このソフト」から「利用ガイド」を開いてください。ガイドの対象バージョンは0.6.0です。
...
v0.6の検証範囲、性能値、既知の制限、更新時の注意事項はリリース準備時に `docs/v0.6-release-candidate-review.md` へ記録します。前版の記録は [v0.5リリース候補レビュー](docs/v0.5-release-candidate-review.md)、[v0.4リリース候補レビュー](docs/v0.4-release-candidate-review.md)、[v0.1リリース候補レビュー](docs/v0.1-release-candidate-review.md) に残しています。
